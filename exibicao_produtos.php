...
$produtos = [
    ...
    ['id' => 6, 'nome' => 'MaxMotion', 'descricao' => 'As Sandalias MaxMotion são feitos para se adaptar ao seu movimento. Com um ajuste flexível e confortável', 'preco' => 49.99, 'imagem' => 'images/sandalia.jpg'],
    ...
    ['id' => 14, 'nome' => 'PowerPace', 'descricao' => 'Os tênis PowerPace são feitos para se adaptar ao seu movimento. Com um ajuste flexível e confortável', 'preco' => 49.99, 'imagem' => 'images/sapato9.jpg'], ['id' => 3, 'nome' => 'SwiftStride', 'descricao' => 'As sandalias SwiftStride são feitos para se adaptar ao seu movimento. Com um ajuste flexível e confortável', 'preco' => 49.99, 'imagem' => 'images/sandalia3.jpg']
];

foreach ($produtos as $produto) {
    echo "<div class='produto'>";
    echo "<img src='" . htmlspecialchars($produto['imagem']) . "' alt='" . htmlspecialchars($produto['nome']) . "' style='width: 250px; height: 250px;'>";
    echo "<h3>" . htmlspecialchars($produto['nome']) . "</h3>";
    echo "<p>" . htmlspecialchars($produto['descricao']) . "</p>";
    echo "<p><strong>Preço:</strong> R$ " . number_format($produto['preco'], 2, ',', '.') . "</p>";
    echo "<button type='button' style='background-color: #142c54;'>Adicionar ao Carrinho</button>";
    echo "</div>";
}
?>
    </div>
